...
```sh
./ft_turing -l log/unary_add.log res/unary_add.json "11+1111="
```

Interactive stdout uses ANSI color for the current tape cell. Redirected stdout and log files use the plain `<x>` marker.
